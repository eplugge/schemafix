CREATE TABLE `admin_ldap_authorized_entity` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `dn` varchar(640) COLLATE utf8_unicode_ci DEFAULT NULL
  `dn_type` varchar(32) COLLATE utf8_unicode_ci NOT NULL
  `name` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `admin_ldap_authorized_entity_to_vsp_role_map` (
  `id` int(11) NOT NULL
  `vsp_role_id` int(11) NOT NULL
  `device_space_id` int(11) NOT NULL
  PRIMARY KEY (`id`,`device_space_id`,`vsp_role_id`)
);
CREATE TABLE `afw_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `app_catalog_id` bigint(20) NOT NULL
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'DEFAULT_CONFIG'
  `priority` int(11) NOT NULL DEFAULT '-1'
  PRIMARY KEY (`id`)
  KEY `fk_afw_config_to_app_catalog` (`app_catalog_id`)
  CONSTRAINT `fk_afw_config_to_app_catalog` FOREIGN KEY (`app_catalog_id`) REFERENCES `app_catalog` (`id`) ON DELETE CASCADE
);
CREATE TABLE `afw_config_label_assoc` (
  `afw_config_id` bigint(20) NOT NULL
  `label_id` bigint(20) NOT NULL
  KEY `fk_afw_config_label_assoc_restriction_id` (`afw_config_id`)
  KEY `fk_afw_config_label_assoc_label_id` (`label_id`)
  CONSTRAINT `fk_afw_config_label_assoc_label_id` FOREIGN KEY (`label_id`) REFERENCES `mi_label` (`id`) ON DELETE CASCADE
  CONSTRAINT `fk_afw_config_label_assoc_restriction_id` FOREIGN KEY (`afw_config_id`) REFERENCES `afw_config` (`id`) ON DELETE CASCADE
);
CREATE TABLE `afw_config_restriction` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'primary key for the android_work_restriction'
  `afw_config_id` bigint(20) DEFAULT NULL
  `restriction_key` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT 'key for the app restriction'
  `restriction_title` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT 'title for the app restriction'
  `restriction_type` varchar(16) COLLATE utf8_unicode_ci NOT NULL COMMENT 'type for the app restriction'
  `restriction_value` text CHARACTER SET utf8 COMMENT 'value for the app restriction'
  `restriction_display_value` text CHARACTER SET utf8 COMMENT 'display value for the app restriction'
  PRIMARY KEY (`id`)
  UNIQUE KEY `android_work_restriction_udx_cat_id_restriction_key` (`afw_config_id`,`restriction_key`)
  CONSTRAINT `fk_afw_config_restriction_to_afw_config_id` FOREIGN KEY (`afw_config_id`) REFERENCES `afw_config` (`id`) ON DELETE CASCADE
);
CREATE TABLE `android_work_permission` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'primary key for the android_work_permission'
  `permission_id` varchar(256) COLLATE utf8_unicode_ci NOT NULL COMMENT 'permission id used for GooglePlay permission operations'
  `language` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'language code for the name and description'
  `name` varchar(128) CHARACTER SET utf8 DEFAULT NULL COMMENT 'name of the permission'
  `description` text CHARACTER SET utf8 COMMENT 'permission description'
  `created_at_timestamp` bigint(20) NOT NULL COMMENT 'timestamp for when the row was created'
  `modified_at_timestamp` bigint(20) DEFAULT NULL COMMENT 'timestamp for when the row was last modified'
  PRIMARY KEY (`id`)
);
CREATE TABLE `android_work_restriction_inventory` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'primary key for the android_work_restriction_inventory'
  `package_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'package name for the app whose restrictions'
  `device_uuid` varchar(64) CHARACTER SET utf8 NOT NULL COMMENT 'uuid of the device'
  `hash` varchar(64) CHARACTER SET utf8 DEFAULT '0' COMMENT 'hash of the values for the specified app for the specified device'
  PRIMARY KEY (`id`)
  UNIQUE KEY `android_work_restriction_inventory_udx_name_device_uuid` (`package_name`,`device_uuid`)
);
CREATE TABLE `app_catalog` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `platform_type` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'platform type'
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'name of the app'
  `version` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'version of the app, only for in-house app'
  `alt_version` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'alternative version of the app, short version for iOS, int version for Android, only for in-house app'
  `display_version` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'version shown in the app storefront, either the version or the alt_version, only for in-house app'
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'identifier, bundle ID of the app or persistent ID of the book, case sensitive'
  `creator_type` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'creator type of the app, either ADMIN or SYSTEM'
  `catalog_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'catalog type, either APP or BOOK'
  `public_store` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the public app store from where the app was imported'
  `public_store_id` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ID in the public app store, can be same as app_id. market app only'
  `developer_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'name of the developer of the app'
  `cost` decimal(19,2) DEFAULT NULL COMMENT 'price in the public app store'
  `currency` varchar(3) COLLATE utf8_unicode_ci DEFAULT 'USD' COMMENT 'currency of the cost'
  `avg_rating` decimal(5,2) DEFAULT NULL COMMENT 'average rating of the app'
  `rating_count` int(11) DEFAULT NULL COMMENT 'count of the ratings'
  `install_size` bigint(20) DEFAULT NULL COMMENT 'size of the installation file'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'if the record is deleted'
  `description` text COLLATE utf8_unicode_ci COMMENT 'description of the app'
  `update_notes` text COLLATE utf8_unicode_ci COMMENT 'update notes'
  PRIMARY KEY (`id`)
  KEY `idx_ac_app_id_platform_version` (`app_id`,`platform_type`,`version`,`alt_version`)
  KEY `idx_ac_public_store_id_platform` (`public_store_id`,`platform_type`)
  KEY `idx_ac_name_platform` (`name`,`platform_type`)
  KEY `idx_ac_catalog_type` (`catalog_type`)
);
CREATE TABLE `app_catalog_entry` (
  `property` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `catalog_id` bigint(20) NOT NULL
  `trash` int(1) NOT NULL DEFAULT '0'
  UNIQUE KEY `ace_catalog_property` (`catalog_id`,`property`)
  KEY `ace_property_value` (`property`,`value`)
  CONSTRAINT `app_catalog_entry_ibfk_1` FOREIGN KEY (`catalog_id`) REFERENCES `app_catalog` (`id`)
);
CREATE TABLE `app_control_failure` (
  `client_id` bigint(20) NOT NULL COMMENT 'client ID of the device'
  `acl_entry_id` bigint(20) NOT NULL COMMENT 'app control entry ID'
  `client_app_inventory_id` bigint(20) DEFAULT NULL COMMENT 'client app inventory ID'
  `created_at` datetime NOT NULL COMMENT 'When the row is created'
  `modified_at` datetime NOT NULL COMMENT 'When the row is updated'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'if the record is deleted'
  KEY `acf_client_id` (`client_id`)
  KEY `acf_client_app_inventory_id` (`client_app_inventory_id`)
);
CREATE TABLE `app_inventory` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `platform_type` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'platform type'
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'name of the app'
  `version` varchar(127) COLLATE utf8_unicode_ci NOT NULL COMMENT 'version of the app'
  `alt_version` varchar(127) COLLATE utf8_unicode_ci NOT NULL COMMENT 'alternative version of the app, short version for iOS, int version for Android'
  `display_version` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'version shown in device details'
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'identifier, bundle ID of the app or persistent ID of the book, case sensitive'
  `source_type` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the source of the app, mainly for Android. ''M'' for market app, ''N'' for non-market'
  `architecture` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'app platform architecture used for for Windows'
  `fingerprint` varchar(512) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'fingerprint of the app, consisting of platform_type, app_id, versions and source_type'
  `permission_count` smallint(6) DEFAULT NULL COMMENT 'number of permission required, Android only'
  `catalog_id` bigint(20) DEFAULT NULL COMMENT 'internal ID of the corresponding app catalog record if exists'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  PRIMARY KEY (`id`)
  UNIQUE KEY `ai_fingerprint` (`fingerprint`)
  KEY `app_inventory_idx_appid_platform_type` (`app_id`,`platform_type`)
  KEY `app_inventory_idx_name_platform_type` (`name`,`platform_type`)
  KEY `app_inventory_idx_catalog_id` (`catalog_id`)
);
CREATE TABLE `app_inventory_summary` (
  `platform_type` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'platform type'
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'identifier, bundle ID of the app or persistent ID of the book, case sensitive'
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'name of the app'
  `first_found` datetime NOT NULL COMMENT 'created_at from APP_INVENTORY table'
  PRIMARY KEY (`platform_type`,`app_id`)
);
CREATE TABLE `app_label_assoc` (
  `catalog_id` bigint(20) NOT NULL COMMENT 'app catalog record ID'
  `label_id` bigint(20) NOT NULL COMMENT 'label ID'
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'last modification time'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'if the record is trashed'
  PRIMARY KEY (`catalog_id`,`label_id`)
  KEY `label_id` (`label_id`)
  CONSTRAINT `app_label_assoc_ibfk_1` FOREIGN KEY (`catalog_id`) REFERENCES `app_catalog` (`id`) ON DELETE CASCADE
  CONSTRAINT `app_label_assoc_ibfk_2` FOREIGN KEY (`label_id`) REFERENCES `mi_label` (`id`)
);
...
CREATE TABLE `application_descriptor` (
  ...
  `app_tunnel_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  `app_tunnel_service` varchar(64) COLLATE utf8_unicode_ci DEFAULT 'not available'
  PRIMARY KEY (`id`)
  UNIQUE KEY `uq_app_desc_tunnel_id` (`app_tunnel_id`)
  KEY `eas_fk_app_desc_to_device` (`app_device_uuid`)
  KEY `idx_app_desc_username` (`user_name`)
  KEY `app_desc_idx_last_sync_time` (`last_sync_time`,`state`)
  CONSTRAINT `fk_app_desc_to_device_uuid` FOREIGN KEY (`app_device_uuid`) REFERENCES `mi_device` (`uuid`)
);
CREATE TABLE `bsp_app_license` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for the bsp_app_license'
  `bsp_app_id` int(11) NOT NULL COMMENT 'Foreign key which refers to id in mi_bsp_app'
  `content_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'License content id which maps from     package details'
  `license_instance_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'License instance id'
  `license_blob` text COLLATE utf8_unicode_ci COMMENT 'License string stored as blob'
  `created_at` datetime NOT NULL COMMENT 'When the row is created'
  `updated_at` datetime NOT NULL COMMENT 'When the row is updated'
  PRIMARY KEY (`id`)
  UNIQUE KEY `bsp_app_license_uk` (`bsp_app_id`,`content_id`)
  CONSTRAINT `bsp_app_license_ibfk_1` FOREIGN KEY (`bsp_app_id`) REFERENCES `mi_bsp_app` (`id`)
);
CREATE TABLE `bsp_app_package_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for the bsp_app_package_details'
  `bsp_app_id` int(11) NOT NULL COMMENT 'Foreign key which refers to id in mi_bsp_app'
  `catalog_id` bigint(20) NOT NULL COMMENT 'Foreign key which refers to id in app_catalog'
  `trash` tinyint(1) NOT NULL COMMENT 'Flag to indicate if the app is deleted or not'
  `package_set_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'BSP app package set id which is used to externally identity the uniqueness'
  `product_package_details_json` text COLLATE utf8_unicode_ci COMMENT 'A JSON string which includes app package details'
  `created_at` datetime NOT NULL COMMENT 'When the row is created'
  `updated_at` datetime NOT NULL COMMENT 'When the row is updated'
  PRIMARY KEY (`id`)
  UNIQUE KEY `package_set_id_uk` (`bsp_app_id`,`package_set_id`)
  KEY `catalog_id_idx` (`catalog_id`)
  CONSTRAINT `bsp_app_package_detail_ibfk_1` FOREIGN KEY (`bsp_app_id`) REFERENCES `mi_bsp_app` (`id`)
  CONSTRAINT `bsp_app_package_detail_ibfk_2` FOREIGN KEY (`catalog_id`) REFERENCES `app_catalog` (`id`)
);
CREATE TABLE `cert_inventory` (
  ...
  `issuer` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  KEY `cert_inventory_common_name` (`common_name`)
);
CREATE TABLE `cert_inventory_to_client` (
  `cert_id` bigint(20) NOT NULL
  `client_id` bigint(20) NOT NULL
  `user_id` varchar(255) CHARACTER SET ascii NOT NULL DEFAULT ''
  PRIMARY KEY (`cert_id`,`client_id`,`user_id`)
...
CREATE TABLE `client_app_inventory` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `client_id` bigint(20) NOT NULL COMMENT 'client ID of the device'
  `inventory_id` bigint(20) DEFAULT NULL COMMENT 'reference to the app_inventory record'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'boolean flag if the record is trashed'
  PRIMARY KEY (`id`)
  UNIQUE KEY `cai_client_id_inventory_id` (`client_id`,`inventory_id`)
  KEY `cai_inventory_id` (`inventory_id`,`trash`)
);
CREATE TABLE `client_managed_app` (
  `client_id` bigint(20) NOT NULL COMMENT 'client ID of the device'
  `catalog_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'catalog type, e.g. app or book etc'
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'bundle ID of the app or persistent ID of the book'
  `catalog_id` bigint(20) DEFAULT NULL COMMENT 'corresponding app catalog record ID'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  `status` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'management status reported by device'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'boolean flag if the record is trashed'
  `validated` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Add isValidated flag for managed app'
  PRIMARY KEY (`client_id`,`catalog_type`,`app_id`)
);
CREATE TABLE `core_update_support` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `version` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `hash` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `update_timestamp` bigint(20) NOT NULL
  `processed_timestamp` bigint(20) DEFAULT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `custom_attribute_definition` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `type` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'indicates device (d) or user (u) attribute'
  `data_type` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'data type of the attribute value'
  `name` varchar(64) CHARACTER SET ascii NOT NULL COMMENT 'attribute name'
  `description` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'description of the attribute'
  `status` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'a' COMMENT 'indicates active (a) or inactive (i) status'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification timestamp'
  PRIMARY KEY (`id`)
  UNIQUE KEY `type` (`type`,`name`)
);
CREATE TABLE `custom_device_attribute` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `device_id` bigint(20) NOT NULL COMMENT 'primary key of the associated device'
  `attribute_id` bigint(20) NOT NULL COMMENT 'primary key of the attribute definition'
  `value` varchar(512) COLLATE utf8_unicode_ci NOT NULL COMMENT 'attribute value'
  PRIMARY KEY (`id`)
  UNIQUE KEY `device_id` (`device_id`,`attribute_id`)
  KEY `attribute_id` (`attribute_id`)
  CONSTRAINT `custom_device_attribute_ibfk_1` FOREIGN KEY (`attribute_id`) REFERENCES `custom_attribute_definition` (`id`) ON DELETE CASCADE
);
CREATE TABLE `custom_user_attribute` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `user_id` bigint(20) NOT NULL COMMENT 'primary key of the associated user'
  `attribute_id` bigint(20) NOT NULL COMMENT 'primary key of the attribute definition'
  `value` varchar(512) COLLATE utf8_unicode_ci NOT NULL COMMENT 'attribute value'
  PRIMARY KEY (`id`)
  UNIQUE KEY `user_id` (`user_id`,`attribute_id`)
  KEY `attribute_id` (`attribute_id`)
  CONSTRAINT `custom_user_attribute_ibfk_1` FOREIGN KEY (`attribute_id`) REFERENCES `custom_attribute_definition` (`id`) ON DELETE CASCADE
);
CREATE TABLE `default_dep_profile` (
  `server_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'primary key - each DEP account can have only one default DEP profle'
  `profile_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'DEP profile uuid respsenting the default DEP profile for the DEP account'
  PRIMARY KEY (`server_uuid`)
);
CREATE TABLE `dep_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `server_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `server_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `description` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL
  `facilitator_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `org_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `org_email` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `org_phone` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `org_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `token` text COLLATE utf8_unicode_ci NOT NULL
  `access_token_expiry` datetime NOT NULL
  `last_synced_at` datetime DEFAULT NULL
  `sync_access_error` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `pending_delete` bit(1) NOT NULL DEFAULT b'0'
  PRIMARY KEY (`id`)
  UNIQUE KEY `name` (`server_uuid`)
);
CREATE TABLE `dep_device` (
  ...
  `device_assigned_by` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `profile_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL
  `profile_uuid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `server_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `dep_profile` (
  `profile_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `server_uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `profile_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `description` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  `url` varchar(1024) COLLATE utf8_unicode_ci NOT NULL
  `allow_pairing` tinyint(1) NOT NULL DEFAULT '1'
  `is_supervised` tinyint(1) NOT NULL DEFAULT '0'
  `is_mandatory` tinyint(1) NOT NULL DEFAULT '0'
  `is_mdm_removable` tinyint(1) NOT NULL DEFAULT '1'
  `support_phone_number` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `org_magic` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `skip_setup_items` bit(16) DEFAULT NULL
  `anchor_certs` text COLLATE utf8_unicode_ci
  `anchor_certs_filenames` text CHARACTER SET utf8
  `supervising_host_certs` text COLLATE utf8_unicode_ci
  `supervising_host_certs_filenames` text CHARACTER SET utf8
  `department` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `pending_delete` bit(1) NOT NULL DEFAULT b'0'
  PRIMARY KEY (`profile_uuid`,`server_uuid`)
  UNIQUE KEY `dep_profile_name_key` (`profile_name`,`server_uuid`)
);
CREATE TABLE `device_feature_usage_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `external_host` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'external host of VSP instance that report is generated for'
  `report` longblob NOT NULL COMMENT 'gzipped file of feature usage report for all active devices'
  `job_fired_at` datetime NOT NULL COMMENT 'report creation job start time'
  `created_at` datetime NOT NULL COMMENT 'report insert time'
  PRIMARY KEY (`id`)
);
CREATE TABLE `device_space` (
  ...
  `criteria` varchar(2048) COLLATE utf8_unicode_ci NOT NULL
  `criteria_fields` varchar(1024) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `device_to_device_space_map` (
  `device_id` bigint(20) NOT NULL
  `uuid` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `client_id` bigint(20) DEFAULT NULL
  `device_space_path` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `updated_at` datetime DEFAULT NULL
  PRIMARY KEY (`device_id`)
  KEY `idx_device_to_device_space_map_on_path` (`device_space_path`)
  KEY `idx_device_to_device_space_map_on_client_id_path` (`client_id`,`device_space_path`)
  KEY `idx_device_to_device_space_map_on_uuid_path` (`uuid`,`device_space_path`)
);
CREATE TABLE `device_to_device_space_migration` (
  `device_id` bigint(20) NOT NULL
  `client_id` bigint(20) DEFAULT NULL
  `device_space_id_from` int(11) NOT NULL
  `device_space_id_to` int(11) NOT NULL
  `created_at` datetime NOT NULL
);
CREATE TABLE `eas_device` (
  ...
  UNIQUE KEY `uq_deviceid_identity` (`device_id`,`identity`,`mailbox_id`)
  ...
  KEY `eas_device_idx_last_sync_time` (`last_sync_time`,`state`,`mi_device_uuid`,`active_sync_status`)
...
CREATE TABLE `eas_domain` (
  ...
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E'
  `release_version` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
...
CREATE TABLE `eas_mailbox` (
  ...
  KEY `idx_eas_mailbox_mailbox_id` (`mailbox_id`)
  KEY `eas_mailbox_idx_guid` (`guid`)
...
CREATE TABLE `eas_proxy` (
  ...
  `kkdcp_config` varchar(4096) COLLATE utf8_unicode_ci DEFAULT NULL
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E'
  `release_version` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
...
CREATE TABLE `enrollment_cert_to_device` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for the enrollment_cert_to_device'
  `client_id` bigint(20) NOT NULL COMMENT 'foreign key which refer to id in mi_client'
  `device_id` bigint(20) NOT NULL COMMENT 'foreign key which refer to id in mi_device'
  `device_uuid` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `new_cert_serial_number` decimal(50,0) DEFAULT NULL
  `cert_serial_number` decimal(50,0) NOT NULL
  PRIMARY KEY (`id`)
  KEY `client_id` (`client_id`)
  KEY `device_id` (`device_id`)
  CONSTRAINT `enrollment_cert_to_device_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `mi_client` (`id`)
  CONSTRAINT `enrollment_cert_to_device_ibfk_2` FOREIGN KEY (`device_id`) REFERENCES `mi_device` (`id`)
);
CREATE TABLE `es_client_catalog_and_inventory_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `client_id` bigint(20) NOT NULL
  `inserted_at` bigint(20) DEFAULT NULL COMMENT 'unix_time when the row is inserted'
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
  PRIMARY KEY (`id`)
);
CREATE TABLE `es_custom_device_attribute_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `device_id` bigint(20) NOT NULL
  `inserted_at` bigint(20) DEFAULT NULL
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
  PRIMARY KEY (`id`)
);
CREATE TABLE `es_custom_user_attribute_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
...
CREATE TABLE `es_eas_device_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `uuid` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `inserted_at` bigint(20) DEFAULT NULL
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
...
CREATE TABLE `es_mdm_device_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `client_id` bigint(20) NOT NULL
  `inserted_at` bigint(20) DEFAULT NULL
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
...
CREATE TABLE `es_mi_device_detail_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `device_id` bigint(20) NOT NULL
  `inserted_at` bigint(20) DEFAULT NULL
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
...
CREATE TABLE `es_wp_mdm_device_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `uuid` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `inserted_at` bigint(20) DEFAULT NULL
  `op` char(1) COLLATE utf8_unicode_ci DEFAULT 'u'
...
CREATE TABLE `google_apps_password` (
  `mi_user_id` bigint(20) NOT NULL COMMENT 'references a row in the mi_user table'
  `encrypted_password` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the encrypted password (ciphertext)'
  `encryption_algorithm_version` int(11) DEFAULT NULL COMMENT 'refers to the version of encryption implementation that MobileIron uses'
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E' COMMENT '''E'': the password has expired; ''G'': a new password has been generated; ''U'': updated to google; ''F'': failed to update to google'
  `password_updated_at` datetime DEFAULT NULL COMMENT 'when the password was updated'
  `modified_at` datetime NOT NULL COMMENT 'when the row was last modified'
  `email_address` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'user email'
  `encrypted_old_password` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the previous password encrypted'
  `google_update_attempts` int(11) NOT NULL DEFAULT '0' COMMENT 'number of attempts of updating to google'
  `note` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'a short note, most likely the failure reason'
  PRIMARY KEY (`mi_user_id`)
);
...
CREATE TABLE `mdm_device` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `udid` varchar(64) CHARACTER SET ascii NOT NULL
  `client_id` bigint(20) NOT NULL
  `topic` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `device_token` varchar(255) CHARACTER SET ascii DEFAULT NULL
  `push_magic` varchar(255) CHARACTER SET ascii DEFAULT NULL
  `unlock_token` varchar(20480) CHARACTER SET ascii DEFAULT NULL
  ...
  `device_info_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `security_info_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `restrictions_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `profile_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `prov_profile_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `cert_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `app_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `managed_app_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `managed_media_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `user_token` varchar(255) CHARACTER SET ascii DEFAULT NULL
  `user_id` varchar(255) CHARACTER SET ascii DEFAULT NULL
  `user_long_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `user_short_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `user_profile_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `user_cert_hash` varchar(64) CHARACTER SET ascii DEFAULT NULL
  `sync_longer_interval` int(11) DEFAULT '42' COMMENT 'column on when to validate app sync'
  PRIMARY KEY (`id`)
...
CREATE TABLE `mdm_notification_event` (
  ...
  `command_args` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  `request_data` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  KEY `idx_mdm_notification_event_on_clientid_state` (`client_id`,`state`,`command`)
  KEY `idx_mdm_notification_event_on_state_priority` (`state`,`priority`)
);
...
CREATE TABLE `mdm_profile_to_client` (
  ...
  `client_id` bigint(20) NOT NULL
  `user_id` varchar(255) CHARACTER SET ascii NOT NULL DEFAULT ''
  PRIMARY KEY (`profile_id`,`client_id`,`user_id`)
...
CREATE TABLE `mi_app_catalog_vpp_to_label` (
  `catalog_id` bigint(20) NOT NULL
  `label_id` bigint(20) NOT NULL
  `vpp_account_id` int(11) NOT NULL DEFAULT '0'
  PRIMARY KEY (`catalog_id`,`label_id`,`vpp_account_id`)
...
CREATE TABLE `mi_app_connect_closed_loop` (
  `type_id` int(11) NOT NULL COMMENT 'the ac type'
  `client_id` bigint(20) NOT NULL COMMENT 'mi_device mi_client_id'
  `app_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT 'the ac app id, usually same as bundle id'
  `modified_at` datetime NOT NULL
  `app_uuid` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the uuid sent up from the app in the PBACAppConfigurationsReport'
  `agent_uuid` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the uuid sent up from the agent in the PBACAgentConfigurationsReport'
  `core_uuid` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the uuid the core sent down'
  `state` varchar(48) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the ac state: enabled, pending_enable, disabled, pending_disable, error'
  `message` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'any messages from the ac app and any message we add through parsing the uuids'
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'the name of the source of the app connect type as sent up by the client'
  `is_old` tinyint(1) DEFAULT NULL COMMENT 'whether we deem the config on the client to be out of date as compared with core'
  PRIMARY KEY (`client_id`,`type_id`,`app_id`)
);
...
CREATE TABLE `mi_app_platforms` (
  ...
  `is_base_platform` char(1) COLLATE utf8_unicode_ci DEFAULT 'f'
  PRIMARY KEY (`id`)
  UNIQUE KEY `platform_name` (`platform_name`)
  KEY `map_idx_01` (`platform_type`,`kernel_name`,`platform_name`)
);
CREATE TABLE `mi_app_reviews` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL
  `summary` varchar(6000) COLLATE utf8_unicode_ci DEFAULT NULL
  `rating` tinyint(4) NOT NULL
  `created_at` datetime NOT NULL
  `modified_at` datetime NOT NULL
  `user_id` bigint(20) NOT NULL
  `app_id` bigint(20) NOT NULL
  `common_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL
  `approved_at` datetime DEFAULT NULL
  `approved_by` bigint(20) DEFAULT NULL
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'p'
  PRIMARY KEY (`id`)
  UNIQUE KEY `uc_app_user` (`common_id`,`user_id`)
  KEY `user_id` (`user_id`)
  KEY `app_id` (`app_id`)
  KEY `common_id_index` (`common_id`)
  CONSTRAINT `mi_app_reviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mi_user` (`id`)
);
CREATE TABLE `mi_app_setting` (
  ...
  `modified_at` bigint(20) DEFAULT NULL
  `device_space_path` varchar(255) COLLATE utf8_unicode_ci DEFAULT '/1/'
  `version_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT '0'
  `app_sub_type` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
...
CREATE TABLE `mi_app_setting_entry` (
  ...
  KEY `pk_app_setting_entry_prop_id` (`property`,`app_setting_id`)
...
CREATE TABLE `mi_app_setting_to_app_catalog` (
  `app_setting_id` bigint(20) NOT NULL
  `app_catalog_id` bigint(20) NOT NULL
  `created_at` datetime NOT NULL
  PRIMARY KEY (`app_setting_id`,`app_catalog_id`)
);
...
CREATE TABLE `mi_bmw_entry` (
  ...
  CONSTRAINT `fk_bmw_acl` FOREIGN KEY (`acl_id`) REFERENCES `mi_bmw_acl` (`id`) ON DELETE CASCADE
);
CREATE TABLE `mi_bsp_app` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for the mi_bsp_app'
  `product_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Product identifier for an application that is used by BSP'
  `sku_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Product identifier that specifies a specific SKU of an application that is used by BSP'
  `license_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'BSP license type (offline/online)'
  `seat_capacity` bigint(20) DEFAULT NULL COMMENT 'Total number seats that have been purchase for an application when import to VSP'
  `available_seats` bigint(20) DEFAULT NULL COMMENT 'Number of available seats remaining for an application when importing to VSP'
  `consumed_seats` bigint(20) DEFAULT NULL COMMENT 'Number of seats is consumed'
  `package_family_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'BSP app package family name'
  `distribution_policy` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Inventory distribution policy (open/restricted)'
  `status` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'App inventory status (active/removed)'
  `version_count` int(11) NOT NULL DEFAULT '0' COMMENT 'Number of versions of the app downloaded'
  `created_at` datetime NOT NULL COMMENT 'When the row is created'
  `updated_at` datetime NOT NULL COMMENT 'When the row is updated'
  PRIMARY KEY (`id`)
  UNIQUE KEY `mi_bsp_app_uk` (`product_id`,`sku_id`)
);
CREATE TABLE `mi_bsp_license_usage` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for the mi_bsp_license_usage'
  `bsp_app_id` int(11) NOT NULL COMMENT 'Foreign key which refers to identifier of bsp app'
  `user_id` bigint(20) NOT NULL COMMENT 'Foreign key which refers to the user who claimed the BSP offline license'
  `device_id` bigint(20) NOT NULL COMMENT 'Foreign key which refers to the device which installed teh BSP offline license'
  `license_usage_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Specifies whether the license has been consumed/reclaimed'
  `created_at` datetime NOT NULL COMMENT 'When offline license is claimed'
  `updated_at` datetime DEFAULT NULL COMMENT 'Time when offline license is updated'
  PRIMARY KEY (`id`)
  UNIQUE KEY `mi_bsp_license_usage_uk` (`bsp_app_id`,`user_id`,`device_id`,`license_usage_status`)
  KEY `user_id` (`user_id`)
  KEY `device_id` (`device_id`)
  CONSTRAINT `mi_bsp_license_usage_ibfk_1` FOREIGN KEY (`bsp_app_id`) REFERENCES `mi_bsp_app` (`id`)
  CONSTRAINT `mi_bsp_license_usage_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `mi_user` (`id`)
  CONSTRAINT `mi_bsp_license_usage_ibfk_3` FOREIGN KEY (`device_id`) REFERENCES `mi_device` (`id`)
);
CREATE TABLE `mi_certificate` (
  ...
  `serial_number` decimal(50,0) DEFAULT NULL
  ...
  `app_setting_id` bigint(20) DEFAULT NULL
  `status` char(1) COLLATE utf8_unicode_ci DEFAULT 'A'
  `thumbprint` varchar(128) CHARACTER SET ascii DEFAULT NULL COMMENT 'thumbprint aka fingerprint aka hash'
  `pkcs12` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 't = pkcs12 cert ; f = not pkcs12 cert ; NULL = not sure'
  `modified_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'When the row is updated'
  PRIMARY KEY (`id`)
  ...
  KEY `active_certificates_idx_localcaid_trash` (`mi_local_ca_id`,`trash`)
  KEY `mi_certificate_idx_status_trash` (`status`,`trash`,`modified_at`)
);
CREATE TABLE `mi_client` (
  ...
  PRIMARY KEY (`id`)
  UNIQUE KEY `mi_client_n01_covering` (`id`,`mi_device_id`,`next_snapshot_version`)
...
CREATE TABLE `mi_client_log` (
  ...
  KEY `mi_client_log_idx_client_id` (`client_id`)
...
CREATE TABLE `mi_compliance_actions` (
  ...
  `modified_at` bigint(20) DEFAULT NULL
  `trash` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'f'
  `local_compliance` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'f'
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `mi_device` (
  ...
  `country_code` varchar(3) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1'
...
CREATE TABLE `mi_device_app_setting_subscription` (
  `device_id` bigint(20) NOT NULL
  `app_setting_id` bigint(20) NOT NULL
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'S'
  `last_updated_at` bigint(20) DEFAULT NULL
  PRIMARY KEY (`device_id`,`app_setting_id`)
  KEY `fk_app_setting_to_device_setting_id` (`app_setting_id`)
  KEY `idx_mi_device_app_setting_subscription_appsetting_state` (`app_setting_id`,`state`)
  CONSTRAINT `fk_device_to_app_setting_subscription_device_id` FOREIGN KEY (`device_id`) REFERENCES `mi_device` (`id`)
  CONSTRAINT `fk_device_to_app_setting_subscription_setting_id` FOREIGN KEY (`app_setting_id`) REFERENCES `mi_app_setting` (`id`)
);
...
CREATE TABLE `mi_device_keyed_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `device_id` bigint(20) NOT NULL COMMENT 'primary key of the device which the property helps describe'
  `category` varchar(40) COLLATE utf8_unicode_ci NOT NULL COMMENT 'key for a group of properties, e.g. a GUID'
  `property` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'name of the stored name-value pair'
  `value` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'value of the stored name-value pair'
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'nobody seems to know what this column is for'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification timestamp'
  PRIMARY KEY (`id`)
  UNIQUE KEY `idx_mi_device_keyed_detail_key_value_property_device_id` (`device_id`,`category`,`property`) COMMENT 'order this index by device_id, then by category, as these are the usual retrieval properties'
  CONSTRAINT `mi_device_keyed_detail_ibfk_1` FOREIGN KEY (`device_id`) REFERENCES `mi_device` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `mi_end_user_tos` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `language` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `tos` text CHARACTER SET utf8
  `created_at_timestamp` bigint(20) NOT NULL
  `modified_at_timestamp` bigint(20) DEFAULT NULL
  PRIMARY KEY (`id`)
  UNIQUE KEY `lang_unique_key` (`language`)
);
...
CREATE TABLE `mi_label` (
  ...
  `device_space_id` int(11) DEFAULT '1'
  `device_space_path` varchar(255) COLLATE utf8_unicode_ci DEFAULT '/1/'
  PRIMARY KEY (`id`)
  UNIQUE KEY `name` (`name`)
...
CREATE TABLE `mi_local_ca` (
  ...
  `client_cert_life_limited` char(1) COLLATE utf8_unicode_ci DEFAULT 'f'
  `ca_expiration` datetime DEFAULT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `mi_local_ca_certs` (
  ...
  KEY `idx_ca_certs_local_ca_id_sn` (`serial_number`,`mi_local_ca_id`)
...
CREATE TABLE `mi_mcc_mnc_codes` (
  ...
  CONSTRAINT `mi_mcc_mnc_codes_to_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `mi_operator` (`id`)
...
CREATE TABLE `mi_notification_event` (
  ...
  `app_data` varchar(4098) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
...
CREATE TABLE `mi_per_app_vpn_accounting` (
  `app_bundle_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `vpnid` bigint(20) NOT NULL
  `client_id` bigint(20) NOT NULL
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `app_id` bigint(20) DEFAULT NULL
  `vpn_from_label` char(1) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
  UNIQUE KEY `id` (`id`)
  UNIQUE KEY `per_app_vpn_accounting_idx` (`app_id`,`vpnid`,`client_id`,`app_bundle_id`)
  KEY `per_app_vpn_accounting_idx_client_id` (`client_id`)
);
...
CREATE TABLE `mi_property` (
  `property` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'Unique property'
  `value` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'value for the associated property, can be large'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  PRIMARY KEY (`property`)
);
CREATE TABLE `mi_protocol_command` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `name` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `protocol_name` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `code` int(11) NOT NULL
  `reply_code` int(11) NOT NULL
  `priority` int(11) NOT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `mi_protocol_command_state` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `name` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `state_name` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `state_type` char(1) COLLATE utf8_unicode_ci NOT NULL
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `mi_resource` (
  ...
  KEY `mi_resource_n01` (`file_id`,`trash`)
...
CREATE TABLE `mi_rule` (
  ...
  `client_value` varchar(2048) COLLATE utf8_unicode_ci DEFAULT NULL
  `policy_id` bigint(20) NOT NULL
...
CREATE TABLE `mi_settings` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `property` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `value` text COLLATE utf8_unicode_ci COMMENT 'setting value'
  `modified_at` datetime NOT NULL
  PRIMARY KEY (`id`)
  UNIQUE KEY `idx_mi_settings_property` (`property`)
);
...
CREATE TABLE `mi_subject_holder` (
  ...
  UNIQUE KEY `id` (`id`)
  UNIQUE KEY `uuid` (`uuid`)
  KEY `mi_subject_holder_idx_uuid_type_profile_hash_profile_pin_etc` (`uuid`,`type`,`profile_hash`,`profile_pin`,`profile_version`,`scep_challenge`,`sync_profile_hash`)
);
...
CREATE TABLE `mi_untrusted_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `created_at` datetime NOT NULL
  ...
  `subject` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  `certificate` blob
  `peer_info` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `mi_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `uuid` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `principal` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  `encryption_algorithm_version` int(11) NOT NULL DEFAULT '0'
  `last_login_ip` char(40) COLLATE utf8_unicode_ci DEFAULT NULL
  `android_work_userid` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `android_work_email_address` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Email address used to correlate with Google Play EMM APIs'
  PRIMARY KEY (`id`)
  UNIQUE KEY `uuid` (`uuid`)
  ...
  KEY `mi_user_idx_uuid_country_and_all` (`uuid`,`country_id`,`created_at`,`created_by`,`email_address`,`account_enabled`,`first_name`,`language_id`,`last_name`,`name`,`password`,`password_hash`,`principal`,`source`,`trash`)
...
CREATE TABLE `mifs_ldap_groups` (
  ...
  `name` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
  PRIMARY KEY (`id`)
  KEY `mifs_ldap_groups_dn` (`dn`(100))
);
...
CREATE TABLE `mifs_ldap_user_attribute_name` (
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
);
...
CREATE TABLE `mifs_ldap_users` (
  ...
  `attribute_count` smallint(6) DEFAULT '0'
  PRIMARY KEY (`id`)
  UNIQUE KEY `ldap_user_identifier` (`dn`,`principal`)
  KEY `mlu_idx_01` (`principal`)
  KEY `idx_mifs_ldap_users_email` (`email`)
  KEY `mifs_ldap_users_dn` (`dn`(100))
);
...
CREATE TABLE `notify_alert` (
  ...
  PRIMARY KEY (`id`)
  UNIQUE KEY `id` (`id`)
  KEY `notify_alert_idx_subscriptionid_isactive` (`event_subscription_id`,`is_active`)
  KEY `notify_alert_idx_alert_date_status_source` (`alert_date`,`alert_status_id`,`source_alert_id`)
  KEY `notify_alert_idx_status` (`alert_status_id`)
);
...
CREATE TABLE `notify_event` (
  ...
  PRIMARY KEY (`id`)
  UNIQUE KEY `id` (`id`)
  KEY `notify_event_idx_is_processed` (`is_processed`)
);
...
CREATE TABLE `notify_event_exclusion` (
  ...
  KEY `notify_event_exclusion_idx_event_device` (`event_subscription_id`,`device_uuid`)
);
...
CREATE TABLE `notify_event_subscriber_data` (
  ...
  `updated_by` varchar(100) COLLATE utf8_unicode_ci NOT NULL
  `updated_at` datetime DEFAULT NULL
  `event_defn_id` bigint(20) DEFAULT NULL COMMENT 'event definition id (type) denormalized from notify_event_subscription'
  `event_subscription_id` bigint(20) DEFAULT NULL COMMENT 'ID denormalized from notify_event_subscription'
  PRIMARY KEY (`id`)
  UNIQUE KEY `id` (`id`)
  UNIQUE KEY `notify_event_subscriber_data_udx_deviceuuid_subscription_id` (`device_uuid`,`event_subscription_id`,`config_param_id`)
...
CREATE TABLE `notify_event_subscription` (
  ...
  `updated_by` varchar(100) COLLATE utf8_unicode_ci NOT NULL
  `updated_at` datetime DEFAULT NULL
  `status_code` varchar(2) COLLATE utf8_unicode_ci DEFAULT 'a' COMMENT 'Status can be a=Active, u=Updating, d=Deleting'
  PRIMARY KEY (`id`)
  UNIQUE KEY `id` (`id`)
);
...
CREATE TABLE `oauth_access_token` (
  `authentication_id` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'uuid of authentication'
  `token_id` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'uuid of token'
  `token` varbinary(10240) NOT NULL COMMENT 'serialized access token'
  `user_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `client_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
  `authentication` varbinary(51200) NOT NULL COMMENT 'serialized org.springframework.security.oauth2.provider.OAuth2Authentication'
  `refresh_token` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'refresh token id'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `expired_at` datetime DEFAULT NULL COMMENT 'the timestamp token will be expired'
  PRIMARY KEY (`authentication_id`)
  UNIQUE KEY `oauth_access_token_udx_token_id` (`token_id`)
);
CREATE TABLE `oauth_client` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `oauth_client_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'client id'
  `oauth_client_secret` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'client secret'
  `name` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'name of the client'
  `settings` text COLLATE utf8_unicode_ci COMMENT 'permission settings of oauth client'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last update time'
  `trash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'boolean flag if the record is trashed'
  PRIMARY KEY (`id`)
  UNIQUE KEY `oauth_client_idx_client_id` (`oauth_client_id`)
);
CREATE TABLE `oauth_code` (
  `code` varchar(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'authorization code'
  `authentication` varbinary(51200) NOT NULL COMMENT 'serialized org.springframework.security.oauth2.provider.OAuth2Authentication'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  PRIMARY KEY (`code`)
);
CREATE TABLE `oauth_refresh_token` (
  `token_id` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'refresh token id'
  `token` varbinary(10240) NOT NULL COMMENT 'serialized refresh token'
  `authentication` varbinary(51200) NOT NULL COMMENT 'serialized org.springframework.security.oauth2.provider.OAuth2Authentication'
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `expired_at` datetime DEFAULT NULL COMMENT 'the timestamp token will be expired'
...
CREATE TABLE `portal_device_registration` (
  ...
  `notify_user_by_sms` char(1) COLLATE utf8_unicode_ci DEFAULT 'f' COMMENT 'To control SMS notification for user'
  PRIMARY KEY (`id`)
  UNIQUE KEY `passcode` (`passcode`)
  KEY `FKA5BAB0024962D7E` (`appliance_id`)
  KEY `idx_portal_device_registration_deviceid` (`deviceId`)
  KEY `idx_portal_device_registration_owner_uuid` (`owner_uuid`)
...
CREATE TABLE `q_activation_request` (
  ...
  `type` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `json_md5` varbinary(8) DEFAULT NULL
  `started_at` datetime DEFAULT NULL
  `client_id` bigint(20) DEFAULT NULL COMMENT 'client_id for device request'
  `queue_id` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ID of the queue that the request is dispatched to'
  PRIMARY KEY (`id`)
  KEY `idx_qar_state_type_client` (`state`,`type`,`client_id`)
  KEY `idx_qar_queue_state_priority` (`queue_id`,`state`,`priority`)
  KEY `idx_qar_md5_state_type` (`json_md5`,`state`,`type`)
);
CREATE TABLE `q_activation_request_cancellation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `qar_id` bigint(20) NOT NULL COMMENT 'ID of the queue activation request that has to be cancelled'
  `queue_id` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ID of the queue that the request was dispatched to'
  PRIMARY KEY (`id`)
  KEY `idx_qar_queue_qar` (`queue_id`,`qar_id`)
);
CREATE TABLE `q_label_eval` (
  `device_uuid` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The UUID of a device that has just gone been marked active; should exist in mi_device'
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'a' COMMENT 'The value from mi_device.status_code or ''d'', which means the maximum number of evaluations has happened'
  `need_wake_up` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Denotes that this device should be woken when the label eval job next runs'
  `num_evals` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'The number of times the evaluation-wakeup function was done'
  `next_eval_at_ms` bigint(20) NOT NULL COMMENT 'The number of milliseconds that must elapse before the next label-evaluation should occur for this device'
  `created_at` datetime NOT NULL COMMENT 'When this row was created'
  `modified_at` datetime NOT NULL COMMENT 'When this row was last modified'
  PRIMARY KEY (`device_uuid`)
  KEY `state` (`state`,`num_evals`,`next_eval_at_ms`) USING BTREE
);
CREATE TABLE `role` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
...
CREATE TABLE `search_index_statistics` (
  `start_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00'
  `type` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
  `document_type` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
  `end_time` datetime NOT NULL
  `total_count` int(11) NOT NULL
  `fail_count` int(11) NOT NULL
  PRIMARY KEY (`start_time`,`type`,`document_type`)
);
...
CREATE TABLE `user_to_vsp_role_mapping` (
  `user_id` bigint(20) NOT NULL
  `vsp_role_id` int(11) NOT NULL DEFAULT '0'
  `device_space_id` int(11) NOT NULL
  PRIMARY KEY (`user_id`,`device_space_id`,`vsp_role_id`)
);
CREATE TABLE `vpp_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL
  `description` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL
  `apple_id` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
  `stoken` varchar(1024) COLLATE utf8_unicode_ci NOT NULL
  `stoken_hash` varchar(256) COLLATE utf8_unicode_ci NOT NULL
  `stoken_modified_date` datetime DEFAULT NULL
  `license_since_token` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL
  `user_since_token` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL
  `last_synced_at` datetime DEFAULT NULL
  `priority` int(11) DEFAULT NULL
  `pending_delete` bit(1) NOT NULL DEFAULT b'0'
  `usersync_status` tinyint(1) DEFAULT NULL
  `licensesync_status` tinyint(1) DEFAULT NULL
  PRIMARY KEY (`id`)
  UNIQUE KEY `name` (`name`)
);
CREATE TABLE `vpp_license` (
  `account_id` int(11) NOT NULL
  `license_id` bigint(20) NOT NULL DEFAULT '0'
  `adam_id` bigint(20) NOT NULL
  `product_type_id` int(11) DEFAULT NULL
  `product_type_name` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL
  `pricing_param` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL
  `is_irrevocable` char(1) COLLATE utf8_unicode_ci DEFAULT NULL
  `user_id` bigint(20) DEFAULT NULL
  `client_user_id_str` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `status` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL
  `its_id_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `serial_number` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Hold serial number of device if license is device based.'
  PRIMARY KEY (`account_id`,`license_id`)
  KEY `license_its_id_hash` (`its_id_hash`)
  KEY `vpp_license_idx_status_user_serial_adam_account` (`status`,`client_user_id_str`,`serial_number`,`adam_id`,`account_id`)
  KEY `vpp_license_idx_adam_account_user_status` (`adam_id`,`account_id`,`client_user_id_str`,`status`)
  KEY `vpp_license_idx_adam_account_serial_status` (`adam_id`,`account_id`,`serial_number`,`status`)
  KEY `vpp_license_idx_adam_account_status` (`adam_id`,`account_id`,`status`)
  CONSTRAINT `vpp_license_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `vpp_account` (`id`)
);
CREATE TABLE `vpp_license_count` (
  `account_id` int(11) NOT NULL COMMENT 'vpp account id'
  `adam_id` bigint(20) NOT NULL COMMENT 'Apples app-book store id'
  `device_count` bigint(20) NOT NULL COMMENT 'devices associated count to license for associated account'
  `user_count` bigint(20) NOT NULL COMMENT 'users associated count to license for associated account'
  `available_count` bigint(20) NOT NULL COMMENT 'unassociated count to license for associated account'
  `total_count` bigint(20) NOT NULL COMMENT 'total count purchased licenses for associated account'
  `last_sync_time` bigint(20) NOT NULL COMMENT 'last sync time in milliseconds of when Core syncd with Apples VPP service'
  `usage_type` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'u' COMMENT 'license usage type per account, adam_id user is the default'
  `modified_at` bigint(20) NOT NULL COMMENT 'last modified at in milliseconds of when the row gets updated like usage_type gets changed'
  PRIMARY KEY (`account_id`,`adam_id`)
);
CREATE TABLE `vpp_license_user` (
  `account_id` int(11) NOT NULL
  `user_id` bigint(20) NOT NULL DEFAULT '0'
  `status` varchar(32) COLLATE utf8_unicode_ci NOT NULL
  `invite_url` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL
  `invite_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `client_user_id_str` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `its_id_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `pending_sync` tinyint(1) DEFAULT '0'
  `email` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Hold email associated to vpp user.'
  PRIMARY KEY (`user_id`,`account_id`)
  KEY `uuid_status_account` (`client_user_id_str`,`status`,`account_id`)
  KEY `idx_vpp_user_idhash` (`its_id_hash`)
);
CREATE TABLE `vsp_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `category_id` int(11) DEFAULT NULL
  `default_space_only` char(1) COLLATE utf8_unicode_ci NOT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `vsp_role_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL
  PRIMARY KEY (`id`)
);
CREATE TABLE `vsp_role_to_permission_map` (
...
CREATE TABLE `wp_mdm_alert` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'auto-generated primary key'
  `device_uuid` varchar(64) COLLATE utf8_unicode_ci NOT NULL
  `state` int(11) DEFAULT NULL
  `alert_type` int(11) NOT NULL COMMENT 'Type of alert'
  `loc_uri` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'locURI of the object'
  `namespace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'namespace identifier - reverse domain name'
  `format` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'format of the data'
  `importance` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'optional - for Generic alert it defines the importance level of the alert message'
  `data` varchar(2000) COLLATE utf8_unicode_ci DEFAULT NULL
  `created_at` datetime NOT NULL COMMENT 'creation timestamp'
  `modified_at` datetime NOT NULL COMMENT 'last modification time'
  PRIMARY KEY (`id`)
  KEY `idx_wp_mdm_alert_on_device_uuid_and_state` (`device_uuid`,`state`)
);
...
CREATE TABLE `wp_mdm_device` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT
  `device_uuid` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `cert_serial_number` decimal(50,0) DEFAULT NULL
  ...
  `app_store_last_sync` bigint(20) DEFAULT '0'
  `non_store_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `non_store_last_sync` bigint(20) DEFAULT '0'
  `system_app_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL
  `system_app_last_sync` bigint(20) DEFAULT '0'
  `win32_hash` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'win32 app inventory hash for device'
  `win32_last_sync` bigint(20) DEFAULT '0' COMMENT 'last sync time of win32 inventory for device'
  PRIMARY KEY (`id`)
  KEY `idx_wp_mdm_device_on_device_uuid` (`device_uuid`)
);
...
CREATE TABLE `wp_mdm_notification_event` (
  ...
  `command_args` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL
  ...
  `response_data` varchar(4096) COLLATE utf8_unicode_ci DEFAULT NULL
  `event_type` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Policy or AppSetting, null for WPMDMNotificationEvent'
  `action` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Add, Remove, or Modify'
  PRIMARY KEY (`id`)
  KEY `idx_wp_mdm_notification_event_on_device_uuid_and_state` (`device_uuid`,`state`)
);
