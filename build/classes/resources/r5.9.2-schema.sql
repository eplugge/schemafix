...
CREATE TABLE `mi_app_permission_count_by_platform` (
  `app_inventory_id` bigint(20) NOT NULL
  `permission_count` bigint(21) NOT NULL DEFAULT '0'
  KEY `app_inventory_id` (`app_inventory_id`)
);
CREATE TABLE `mi_app_permission_count_by_platform2` (
  `app_inventory_id` bigint(20) NOT NULL
  `permission_count` bigint(21) NOT NULL DEFAULT '0'
  KEY `app_inventory_id` (`app_inventory_id`)
);
